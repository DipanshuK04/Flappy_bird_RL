...
def calculate_SMavg(data,size_of_window):                # for calculating Simple Moving Average
    SMA = []
...
# print(Q)
# print(len(Q)) 
# print('max',max(Q.keys()))
# print('min',min(Q.keys()))           
...
SMA_reward = calculate_SMavg(reward_function,SMA_window_size)
...
SMA_score = calculate_SMavg(score_function,SMA_window_size)
...
SMA_test_rewards = calculate_SMavg(test_rew_episode,SMA_window_size)
...
SMA_test_scores = calculate_SMavg(test_scores,SMA_window_size)
